...
namespace TreesLibrary
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            tree.Root.Children[2].Children = //150
                [
                new() { Data = 30, Parent = tree.Root.Children[2] },
                new() { Data = 5, Parent = tree.Root.Children[2] },
                new() { Data = 11, Parent = tree.Root.Children[2] }
                ];
            tree.Root.Children[2].Children[0].Children = //30
               [
               new() { Data = 96, Parent = tree.Root.Children[2].Children },
               new() { Data = 9, Parent = tree.Root.Children[2].Children }
               ];
            ...
            tree.Root.Children[0].Children = //50
              [
              new() { Data = 12, Parent = tree.Root.Children[0] }
              ];
            tree.Root.Children[0].Children[0].Children = //12
                [
                 new() { Data = 45, Parent = tree.Root.Children[0].Children[0] },
                 new() { Data = 21, Parent = tree.Root.Children[0].Children[0] }
                ];
            tree.Root.Children[0].Children[0].Children[0].Children[1].Children = //21
                [
                 new() { Data = 6, Parent = tree.Root.Children[0].Children[0].Children[1]} //6
                ];
